...
import { companyLinks, supportLinks } from "../data/footer";

import sendIcon from "../assets/Footer/send.svg";

const Footer = () => {
  return (
    <footer className="px-4 mx-auto text-neutralSilver max-w-screen-2xl lg:px-14 bg-neutralBlack">
      {/* Footer Container */}
      <div
        id="footer__container"
        className="flex flex-wrap justify-between py-6 md:py-10 "
      >
        ...
        <div className="flex flex-col justify-between flex-1 gap-6">
          ...
          <p className="text-sm font-normal text-neutralSilver">
            All rights reserved.
          </p>
        ...
        {/* Useful Links and Subscription Letters */}
        {/* Take up full width on screens < 1024 px */}
        <div className="flex flex-col justify-between w-full gap-12 mt-8 lg:w-auto lg:justify-around lg:mt-0 md:flex-row">
          {/* Company */}
          <ul className="flex flex-col gap-3">
            ...
            {companyLinks.map((link) => (
              <li
                key={link.id}
                className="text-sm font-light duration-200 hover:text-brandPrimary text-neutralSilver"
              >
          ...
          <ul className="flex flex-col gap-3">
            ...
            {supportLinks.map((link) => (
              <li
                key={link.id}
                className="text-sm font-light duration-200 text-neutralSilver hover:text-brandPrimary"
              >
                <a href={link.href}>{link.title}</a>
              </li>
            ))}
